...
<style scoped>
    .test h2{background-color:#fff;text-align: center;border-bottom:2px solid #eaeaea;line-height: 40px;height: 40px;width:100%;position: fixed;top:0;left:0;z-index:999;margin:0}
